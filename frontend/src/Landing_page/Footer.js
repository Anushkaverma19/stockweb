...
function Footer() {
    return (
        <div style={{backgroundColor:"00f"}} className="container border-top mt-5">
            <div className='row mt-5'>
                <div className='col-3'>
                    <img src="/media/images/logo.svg" alt="hero" style={{ width: "50%" }} />
